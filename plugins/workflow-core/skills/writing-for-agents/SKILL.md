...
Use the current platform's official skill mechanics as authoritative when this reference differs.

Preserve concise exclusions when they materially prevent misrouting, even though positive wording is the normal preference.

Do not turn an example, preference, or past failure into a universal requirement without evidence that the broader rule improves behavior.
