...
Code examples for the rules in `SKILL.md`.

Use the repository's conventions and validate untrusted data where it enters the typed system.
...
Validate once where data crosses in, then trust the validated types inside.
